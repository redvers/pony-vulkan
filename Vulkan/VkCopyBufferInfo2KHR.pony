...
/*
  Source: /nix/store/009nbc0glwp0pg5x0gzcbwfpyidpkibw-vulkan-headers-1.2.189.1/include/vulkan/vulkan_core.h:8219
  ...
  Fields (Offset in bits):
     ...
     000192: [PointerType size=64]->[Struct size=,fid: f7]: dstBuffer  
     000256: [FundamentalType(unsigned int) size=32]: regionCount  
     000320: [PointerType size=64]->[Struct size=320,fid: f7]: pRegions  
*/
